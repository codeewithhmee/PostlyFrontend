...
const GetSearchedBlog = ({ blog_name ,category}) => {
  ...
  useEffect(() => {
    const fetchBlogs = async () => {
      ...
      try {
        const res = await fetch(
          `https://postlybackend-ovcm.onrender.com/api/blogs/searched_blog/?page=${page}&limit=10&blogName=${blog_name}&category=${category}`,
          {
            credentials: "include",
          },
        );
    ...
    fetchBlogs();
  }, [page, navigate, blog_name,category]);
